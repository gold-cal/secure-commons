...
import com.secure.commons.extensions.getInternalStoragePath
import com.secure.commons.extensions.getSDCardPath
import com.secure.commons.extensions.getSharedPrefs
...
open class BaseConfig(val context: Context) {
    ...
    var textColor: Int
        get() = prefs.getInt(TEXT_COLOR, context.resources.getColor(R.color.default_text_color, null))
        set(textColor) = prefs.edit().putInt(TEXT_COLOR, textColor).apply()

    var backgroundColor: Int
        get() = prefs.getInt(BACKGROUND_COLOR, context.resources.getColor(R.color.default_background_color, null))
        set(backgroundColor) = prefs.edit().putInt(BACKGROUND_COLOR, backgroundColor).apply()

    var primaryColor: Int
        get() = prefs.getInt(PRIMARY_COLOR, context.resources.getColor(R.color.default_primary_color, null))
        set(primaryColor) = prefs.edit().putInt(PRIMARY_COLOR, primaryColor).apply()

    var accentColor: Int
        get() = prefs.getInt(ACCENT_COLOR, context.resources.getColor(R.color.default_accent_color, null))
    ...
    /*var lastIconColor: Int
        get() = prefs.getInt(LAST_ICON_COLOR, context.resources.getColor(R.color.color_icon, null))
    ...
    var widgetBgColor: Int
        get() = prefs.getInt(WIDGET_BG_COLOR, context.resources.getColor(R.color.default_widget_bg_color, null))
        set(widgetBgColor) = prefs.edit().putInt(WIDGET_BG_COLOR, widgetBgColor).apply()

    var widgetTextColor: Int
        get() = prefs.getInt(WIDGET_TEXT_COLOR, context.resources.getColor(R.color.default_widget_text_color, null))
        set(widgetTextColor) = prefs.edit().putInt(WIDGET_TEXT_COLOR, widgetTextColor).apply()

    var widgetDayColor: Int
        get() = prefs.getInt(WIDGET_DAY_COLOR, context.resources.getColor(R.color.default_widget_day_color, null))
        set(widgetDayColor) = prefs.edit().putInt(WIDGET_DAY_COLOR, widgetDayColor).apply()
    ...
    internal var colorPickerRecentColors: LinkedList<Int>
        get(): LinkedList<Int> {
            val defaultList = arrayListOf(
                context.resources.getColor(R.color.md_red_700, null),
                context.resources.getColor(R.color.md_blue_700, null),
                context.resources.getColor(R.color.md_green_700, null),
                context.resources.getColor(R.color.md_yellow_700, null),
                context.resources.getColor(R.color.md_orange_700, null)
            )
