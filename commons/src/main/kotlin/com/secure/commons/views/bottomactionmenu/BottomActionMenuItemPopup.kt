package com.secure.commons.views.bottomactionmenu
/*
...
import com.secure.commons.databinding.ItemActionModePopupBinding
import com.secure.commons.extensions.applyColorFilter
import com.secure.commons.extensions.windowManager
...
class BottomActionMenuItemPopup(
    ...
    private val popupListAdapter = object : ArrayAdapter<BottomActionMenuItem>(context, R.layout.item_action_mode_popup, items) {
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            if (view == null) {
                view = ItemActionModePopupBinding.inflate(LayoutInflater.from(context), parent, false).root
                    //LayoutInflater.from(context).inflate(R.layout.item_action_mode_popup, parent, false)
            }
