...
import androidx.appcompat.R.id.action_mode_close_button
import androidx.recyclerview.widget.DividerItemDecoration
import androidx.recyclerview.widget.RecyclerView
import com.secure.commons.R
import com.secure.commons.activities.BaseSimpleActivity
import com.secure.commons.extensions.*
import com.secure.commons.interfaces.MyActionModeCallback
...
abstract class MyRecyclerViewAdapter(val activity: BaseSimpleActivity, val recyclerView: MyRecyclerView, val itemClick: (Any) -> Unit) :
    ...
    protected var dayBackgroundColor = baseConfig.widgetDayColor
    ...
    protected var properAccentColor = activity.getProperAccentColor()
            ...
            override fun onCreateActionMode(actionMode: ActionMode, menu: Menu?): Boolean {
                ...
                if (baseConfig.isUsingSystemTheme) {
                    actBarTextView?.onGlobalLayout {
                        val backArrow = activity.findViewById<ImageView>(action_mode_close_button)
    ...
    /*open inner class MyAdapter<VH : MyRecyclerViewAdapter.ViewHolder> {
