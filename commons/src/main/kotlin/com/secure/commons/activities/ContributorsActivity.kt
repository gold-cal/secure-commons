...
import com.secure.commons.databinding.ActivityContributorsBinding
import com.secure.commons.databinding.ItemLanguageContributorBinding
...
import com.secure.commons.models.LanguageContributor
...
class ContributorsActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.contributorsTranslationLabel.setTextColor(accentColor)
        ...
        languages.forEach { language ->
            val itemLanguage = ItemLanguageContributorBinding.inflate(layoutInflater).apply {
