...
import com.secure.commons.databinding.DialogLineColorPickerBinding
import com.secure.commons.extensions.*
import com.secure.commons.interfaces.LineColorPickerListener
...
class LineColorPickerDialog(
    ...
    val appIconIDs: ArrayList<Int>? = null, val toolbar: Toolbar? = null, val callback: (wasPositivePressed: Boolean, color: Int) -> Unit
) {
    private val PRIMARY_COLORS_COUNT = 19
    private val DEFAULT_PRIMARY_COLOR_INDEX = 14
    private val DEFAULT_SECONDARY_COLOR_INDEX = 6
    private val DEFAULT_COLOR_VALUE = activity.resources.getColor(R.color.color_primary, null)
