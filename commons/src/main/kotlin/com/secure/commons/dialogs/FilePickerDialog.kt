...
import com.secure.commons.adapters.FilepickerFavoritesAdapter
import com.secure.commons.adapters.FilepickerItemsAdapter
import com.secure.commons.databinding.DialogFilepickerBinding
import com.secure.commons.extensions.*
import com.secure.commons.helpers.ensureBackgroundThread
import com.secure.commons.models.FileDirItem
import com.secure.commons.views.Breadcrumbs
import java.io.File
...
class FilePickerDialog(
    ...
    private var mDialogView = DialogFilepickerBinding.inflate(activity.layoutInflater)
    ...
    private fun updateItems(items: ArrayList<FileDirItem>) {
        ...
        mDialogView.apply {
            ...
            if (root.context.areSystemAnimationsEnabled) {
                filepickerBreadcrumbs.scheduleLayoutAnimation()
            }
